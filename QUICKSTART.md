...
- **Gate PRs in CI**: add the composite action (`uses: shidesheng0218/vlm-diff@v0.6.0`) after committing `.vlm-diff/baseline/` — see the GitHub Action section in [README.md](README.md)
